 ...
 * @author Juuz
 */
public interface ModImplementedContainer extends Container
{
	/**
	 ...
	 */
	static ModImplementedContainer of(NonNullList<ItemStack> items) {
		return () -> items;
	}
	 ...
	 */
	static ModImplementedContainer ofSize(int size) {
